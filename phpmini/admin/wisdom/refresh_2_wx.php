...
<script type="text/javascript">
    function returnweixin(){
		        window.location.href="http://www.gzsensoft.com/shenghui/www.php";
...
<body>
<form id="myForm" action="/shenghui/refresh_2_wx.php?type=<?php echo $_GET['type'] ?>&id=<?php echo $_GET['id'] ?>" method="post">
...
<?php
$keyp = "KEY1";
$indir = "/data/app/wx/phpmini/ueditor/php/html/shenghui/";
$outdir = "/data/app/wx/code_shenghui/file/file/";
...
for ( ; $idx < 4; $idx++)
{
	...
	for ($sub = 1; $sub < 5; $sub++)
	{
		...
		$url = "http://www.gzsensoft.com/wwz/wwz_shenghui.php?type=$keyp$idx&id=$sub";
