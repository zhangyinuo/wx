...
<?php
	foreach ($keys as $k)
	{
		...
		echo "<td><a href='edit_account.php?tel={$k}'>修改</a> <a href='dispatch.php?tel={$k}'>派发</a> <a href='detail.php?tel={$k}'>详细</a> <a  href='#' onclick='return doDel(\"{$k}\");'>删除</a><a href='send_messages.php?tel={$k}'>发送</a><a href='messages.php?tel={$k}'>留言</a> </td> </tr>";
	}
?>
</tbody></table>
<?php 
